  ...
  return (
    <Container>
      <Row>
              ...
              <Accordion.Collapse eventKey="0">
                <Card.Body className="CardBody0 fluid">
                  <ul>
                    ...
                    <li><a href="https://www.indeed.com/cmp?q=Software+Developer&l=&from=discovery-cmp-search">Software Developer Job Reviews</a>
                      <button>Save</button></li>
                ...
                <Card.Body className="CardBody2 fluid">
                  <ul>
                    <li><a href="https://www.udemy.com/">Udemy</a>
                      <button>Save</button></li>
                    <li><a href="https://www.codecademy.com/">Codecadamy</a>
                      <button>Save</button></li>
        ...
        <Col>
          <img className="SmallImg fluid" src="https://i.imgur.com/AMJfimR.jpg"></img>
        </Col>
      </Row>
    </Container>
  )
